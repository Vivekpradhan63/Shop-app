...
import { Eye, EyeOff, ShoppingBag, Phone, Lock, ArrowRight } from "lucide-react";
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={submitting}
              className="group relative w-full h-12 overflow-hidden bg-gradient-to-r from-blue-500 to-indigo-600 font-semibold text-white shadow-lg shadow-blue-500/30 hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 border-0"
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs text-white/30">
              <span className="bg-transparent px-2">New to The SHOP?</span>
            </div>
          </div>
